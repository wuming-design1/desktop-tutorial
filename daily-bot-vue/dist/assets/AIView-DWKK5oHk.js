import{Cn as e,Jn as t,Tn as n,_n as r,bn as i,fr as a,lr as o,nr as s,t as c,v as l,vn as u,wn as d,xn as f,yn as p,zn as m}from"./_plugin-vue_export-helper-DQqo347O.js";import{t as h}from"./Card-B0kgj1tE.js";import{t as g}from"./Spin-COGV2xCK.js";import{D as _,N as v,h as y,r as b}from"./index-BdabP5k7.js";var x={class:`ai-view`},S={class:`config-row`},C={class:`config-item`},w={class:`config-item`},T={class:`config-value`},E={class:`action-row`},D={class:`report-content`},O={key:1,class:`loading-hint`},k=c(n({__name:`AIView`,setup(n){let c=b(),k=y(),A=r(()=>c.getCred(`AI_API_KEY`)||``),j=r(()=>c.getCred(`AI_BASE_URL`)||``),M=r(()=>c.getCred(`AI_MODEL`)||``),N=r(()=>c.isConnected(`ai`)),P=s(!1),F=s(!1),I=s(``);async function L(){if(!A.value||!j.value){k.warning(`请先填写 API Key 和 Base URL`);return}P.value=!0;try{let e=j.value.replace(/\/$/,``)+`/models`;await l.get(e,{headers:{Authorization:`Bearer ${A.value}`}}),k.success(`连接成功`)}catch(e){k.error(`连接失败: ${e?.response?.data?.error?.message||e.message}`)}finally{P.value=!1}}async function R(){F.value=!0,I.value=``,await new Promise(e=>setTimeout(e,1500));let e=`╔══════════════════════════════════════════╗
║        📊 团队工作流智能分析报告          ║
