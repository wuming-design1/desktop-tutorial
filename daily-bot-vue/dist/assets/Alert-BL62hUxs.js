...
`,[i(`border`,`
 ...
 padding-right: 24px;
 `)])]),i(`icon`,{color:`var(--n-icon-color)`}),n(`alert-body`,{padding:`var(--n-padding)`},[i(`title`,{color:`var(--n-title-text-color)`}),i(`content`,{color:`var(--n-content-text-color)`})]),O({originalTransition:`transform .3s var(--n-bezier)`,enterToProps:{transform:`scale(1)`},leaveToProps:{transform:`scale(0.9)`}}),i(`icon`,`
 position: absolute;
 left: 0;
 top: 0;
 align-items: center;
